...
`;
  ...
  class Playlist extends Lightning.Component {
    static _template() {
      return {
        flex: {
          direction: 'row'
...
`;
  ...
  class Advanced extends Page {
    ...
    _init() {
      ...
      this.tag('Ui.Playlist').selected = this._videoIndex; // Fill Ui.Buttons tag with buttons from the buttons array
    ...
    _getFocused() {
      return this._rowIndex === 0 ? this.tag('Ui.Playlist') : this.tag('Ui.Buttons').children[this._index];
    }
  ...
  const routes = [{
    ...
    component: Advanced // component: Player,
