 ...
 * CLI version: 2.7.1
 * 
 * Generated: Thu, 20 Jan 2022 08:59:13 GMT
 */
...
var APP_com_metrological_app_vod_example = (function () {
  ...
  var Player = /*#__PURE__*/function (_Page) {
    ...
    _createClass(Player, [{
      ...
      value: function _setup() {
        ...
        this._progressAnimation.on('progress', function (percentage) {
          /*
          ...
          */
          ...
          _this.tag('Troth').w = w * percentage + 20;
        }); //When the asset is starting


        this._progressAnimation.on('start', function () {
          _this._showEventMessage("handle player start");
        ...
        this._progressAnimation.on('stop', function (p) {
          _this._showEventMessage("handle player stop");
      ...
      value: function _startOverlayTimeout() {
        ...
        this._overlayTimeout = setTimeout(function () {
          ...
          if (_this2.active && _this2._progressAnimation.isActive()) {
            ...
            _this2._showEventMessage("hiding controls during playback");
          }
        }, 3000);
      }
    }, {
      ...
      key: "_showEventMessage",
      value: function _showEventMessage(message) {
        var eventMessage = this.tag('EventMessage');
      ...
      value: function _inactive() {
        ...
        this._hideControls.stopNow(); //playback placeholder remove from code when implementing player
  ...
  var _fetchPageData = function _fetchPageData(lists) {
    var itemParams = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var calls = lists.map(function (_ref2) {
      var path = _ref2.path,
          params = _ref2.params;
      return getRequest({
        target: path,
    ...
    return Promise.all(calls).then(function (response) {
      return response.map(function (list, index) {
        return _objectSpread2(_objectSpread2({
  ...
  var getSearchResults = function getSearchResults(query) {
    return getRequest({
      ...
      response.results = response.results.filter(function (_ref3) {
        var media_type = _ref3.media_type,
            poster_path = _ref3.poster_path;
  ...
  var getMoviesPage = function getMoviesPage() {
    var currentDate = new Date();

    var futureDate = _futureDate(currentDate);

    var pastDate = _pastDate(currentDate);
  ...
  var getSeriesPage = function getSeriesPage() {
    var currentDate = new Date();
    var formatCurrentDate = "".concat(_nomalizeDatePart(currentDate.getDay()), "-").concat(_nomalizeDatePart(currentDate.getMonth() + 1), "-").concat(currentDate.getFullYear());
    return _fetchPageData([{
      path: 'discover/tv',
      title: 'Most Popular'
    }, {
  ...
  var _futureDate = function _futureDate(date) {
  ...
  var _pastDate = function _pastDate(date) {
    var currentYear = date.getFullYear();
    var currentMonth = date.getMonth();
    var currentDay = date.getDay();
    var pastMonth = currentMonth - 1;
    var pastYear = currentYear;
    var pastDay = Math.min(28, currentDay);
  ...
  var _nomalizeDatePart = function _nomalizeDatePart(num) {
    if ((num + '').length === 1) {
      return '0' + num;
    }
  ...
  var applyPlayerModel = function applyPlayerModel(item) {
    ...
    var backdropPath = backdrops.length > 0 ? backdrops[Math.min(1, backdrops.length - 1)].file_path : '';
    return {
      id: id,
      title: media_type === 'tv' ? name : title,
  ...
  var routes = [{
    ...
    component: Main,
    on: function () {
      var _on2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(page) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                getMoviesPage().then(function (response) {
                  page.addStrips(createPageComponents(response));
                  return true;
                });
    ...
    component: Main,
    on: function () {
      var _on3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(page) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                getSeriesPage().then(function (response) {
                  page.addStrips(createPageComponents(response));
                  return true;
                });
      ...
      function on(_x3) {
        return _on3.apply(this, arguments);
      }
    ...
    widgets: ['inputfield'],
    on: function () {
      var _on4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(page) {
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                page.onSearch = /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(input) {
                    return regeneratorRuntime.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            return _context4.abrupt("return", getSearchResults(input).then(function (response) {
      ...
      function on(_x4) {
        return _on4.apply(this, arguments);
      }
    ...
    component: Detail,
    before: function () {
      var _before = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(page, _ref3) {
    ...
    component: Player,
    before: function () {
      var _before2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(page, _ref4) {
        var mediaType, mediaId;
